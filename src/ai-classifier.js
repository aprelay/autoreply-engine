...
5. Acknowledge what they said specifically (show you read their email)${research && research.summary ? `\n5b. Using the COMPANY RESEARCH, name the SPECIFIC service ${research.companyName || 'their company'} offers that you are interested in, and express that you'd like to engage them for it (you are the interested client). Reference their company by its REAL name only — never a slogan.` : `\n5b. IMPORTANT — you do NOT have any verified information about the sender's company or what services they provide. Therefore you MUST NOT name, guess, or invent any specific service, industry, or offering (do NOT say things like "fire restoration", "printing", "renovation", etc.). Keep it GENERIC: say you have a business requirement / project you'd like to discuss and want to see if there's a fit. Do NOT claim to want to "engage" any named company. NEVER mention your own company ("${personaCompany || personaName}") as something to hire or engage — your company only appears in the sign-off, never in the body.`}
